...
<html>
  ...
  <body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-2 col-md-2 mr-0" style="bacground-color:#dea450;" href="#">Trans UPN</a>
    </nav>
      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column" style="margin-top:50px; weight: 70px;">
              <li class="nav-item" style= "background-color: #dea450;">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
          <?php 
           ...
           ?>
            <h2 class= "font" style="margin: 30px 30px 30px 30px;  text-align: center;">Data Bus</h2>
            <div class = "item3">
                <form method = "get">
            ...
            <h2 style="margin: 30px 0 30px 0; text-align: center;">Data Driver</h2>
            <div class="table-responsive">
            <table border="1" class="table table-striped table-sm">
              <thead>
                <tr>
            ...
            <h2 style="margin: 30px 0 30px 0; text-align: center;">Data Kondektur</h2>
            <div class="table-responsive">
            <table border="1" class="table table-striped table-sm">
              <thead>
                <tr>
            ...
            <h2 style="margin: 30px 0 30px 0; text-align: center;">Data Trans UPN</h2>
            <div class="table-responsive">
            <table border="1" class="table table-striped table-sm">
              <thead>
                <tr>
